...
# uncorrelated_data = np.load("ising_temp2.269_uncorrelated9x9from9x9.npy")[:10000,:9,:9]
uncorrelated_data = np.load("../x81x81/ising_temp2.269_uncorrelated81x81.npz")["arr_0"][:10000,:9,:9]
correlated_data = np.load("../../../ising81x81.npz")["arr_0"][:10000,:9,:9]
# correlated_data = np.load("ising_temp2.269_correlated9x9from9x9.npy")[:10000,:9,:9]
...
print("Correlated", correlated_data[10])
