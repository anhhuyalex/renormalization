...
# for k in 1 2 3 4 5 6 8 10 15; do python -u mnist_classification.py ./data  --coarsegrain_blocksize  $k --num_hidden_features $i --num_train_samples $j  --fileprefix upsample_calibrated_line_randomfeatures_lr0.1_wd1em5_mnistAUG28 --lr 0.1 --nonlinearity line --train_method gradient_descent --epochs 150  --upsample  ; done # --upsample   --wd 0.0000000000000000000000001
for k in 1 2 3 4 5 6 8 10 15; do python -u mnist_classification_wholenetwork.py ./data  --coarsegrain_blocksize  $k --num_hidden_features $i --num_train_samples $j  --fileprefix upsample_calibrated_tanh_wholenetwork_lr0.001_wd1em5_mnistAUG28 --lr 0.001 --nonlinearity tanh --train_method gradient_descent --epochs 150  --upsample; done #    --wd 0.0000000000000000000000001
