...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        ...
        print("models.__dict__[args.arch]", models.__dict__[args.arch])
        print("=> creating ensemble of {} models of architecture '{}'".format(args.num_models_ensemble, args.arch))
        model = torchensemble.VotingClassifier(
            estimator=models.__dict__[args.arch],                       # estimator is your pytorch model
            n_estimators=args.num_models_ensemble,                        # number of base estimators
            cuda=True,
        ) 
...
#             model = torch.nn.DataParallel(model).cuda()
    ...
    model.fit(
        train_loader,
        epochs=record.train_params.num_train_epochs,
